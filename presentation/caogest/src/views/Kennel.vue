    ...
    <div id = "kennel" class = "Kennel">
        ...
        <div>
            ...
            <v-card flat height = "100" color = "brown lighten-5">
                <v-card-text class = "display-2 black--text text-center">Canil 123</v-card-text>
            </v-card>
            ...
            <v-card flat>
                <v-row>
                    ...
                    <v-spacer></v-spacer>
                    <v-col>
                        <v-btn class="ma-6 headline" x-large color = "brown lighten-4" to="/informacoes">Informações</v-btn>
                    </v-col>
                    <v-spacer></v-spacer>
                    <v-col>
                        <v-btn class="ma-6 headline" x-large color = "brown lighten-4" to="/partnerships">Parcerias</v-btn>
                    </v-col>
                    <v-spacer></v-spacer>
                </v-row>
            </v-card>
